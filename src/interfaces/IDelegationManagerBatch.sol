...
import {Delegation, Action} from "delegation-framework/src/interfaces/IDelegationManager.sol";

interface IDelegationManagerBatch {
    ////////////////////////////// Events //////////////////////////////
    ...
    function redeemDelegation(bytes calldata _data, bytes32 mode, bytes calldata callData) external;
